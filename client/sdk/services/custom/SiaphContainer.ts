...
/**
 * Api services for the `SiaphContainer` model.
 */
@Injectable()
export class SiaphContainerApi extends BaseLoopBackApi {
   ...
   * <em>
   * (The remote method definition does not provide any description.
   * This usually means the response is a `SiaphContainer` object.)
   * </em>
   */
  ...
  public getFiles(container: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/SiaphContainers/:container/files";
    let _routeParams: any = {
      container: container
    };
    let _postBody: any = {};
  ...
  public getFile(container: any, file: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/SiaphContainers/:container/files/:file";
    let _routeParams: any = {
      container: container,
      file: file
    };
  ...
  public upload(container: any, req: any = {}, res: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/SiaphContainers/:container/upload";
    let _routeParams: any = {
      container: container
    };
    let _postBody: any = {};
  ...
  public download(container: any, file: any, req: any = {}, res: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/SiaphContainers/:container/download/:file";
    let _routeParams: any = {
      container: container,
      file: file
    };
